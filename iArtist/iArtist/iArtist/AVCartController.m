...
- (void)viewDidLoad {
    ...
    self.totalAmount.text = [@"Total Amount: " stringByAppendingString:
                             [NSString stringWithFormat:@"%d", (int)[self.pictureArray count]]];
    ...
    self.totalPrise.text = [@"Total Prise: " stringByAppendingString:[NSString stringWithFormat:@"%d", (int)totalNumber]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.picturePrise.text = [NSString stringWithFormat: @"%d", (int)currentPicture.prise];
...
- (void)reload{
    ...
    totalAmount --;
    self.totalAmount.text = [@"Total Amount: " stringByAppendingString:[NSString stringWithFormat:@"%d", (int)totalAmount]];
    ...
    self.totalPrise.text = [@"Total Prise: " stringByAppendingString:[NSString stringWithFormat:@"%d", (int)totalPrise]];
