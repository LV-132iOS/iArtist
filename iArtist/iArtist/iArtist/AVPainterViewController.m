...
- (void) setImageWithWall :(UIImage *)image :(CGPoint)pictureCenter :(AVTypeOfPictureChange)typeOfPictureChange{
    NSDictionary *CurrentArtist = [[NSDictionary alloc]init];
    NSDictionary *CurrentPainting = [[NSDictionary alloc]init];

    CurrentPainting = [self.PictureData valueForKey:[NSString stringWithFormat:@"%ld",self.pictureIndex]];
    CurrentArtist = [self.PictureData valueForKeyPath:[NSString stringWithFormat:@"%ld.artistId",self.pictureIndex]];
    NSNumber *alpha = @1;
    ...
    self.price.text = [CurrentPainting valueForKey:@"price"];
    self.pictureSize.text = [CurrentPainting valueForKey:@"size"];
    NSData *imageData = [[NSData alloc]initWithBase64EncodedString:[CurrentArtist valueForKey:@"thumbnail"] options:NSDataBase64DecodingIgnoreUnknownCharacters];
    UIImage *img = [UIImage imageWithData:imageData];
    self.authorsImage.image  = img;
    self.authorsName.text = [CurrentArtist valueForKey:@"name"];
